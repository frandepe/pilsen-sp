import { Paper, InputBase,fade, makeStyles, Button, IconButton } from '@material-ui/core'
...
const AddTitleCardOrList = ({type, setOpen, listId}) => {
  ...
  return (
     ...
     <Paper className={classes.card}>
          <InputBase
          multiline
          placeholder={type === "card" ? 'Ingresa en titulo de la tarjeta':'Ingresa en titulo de la Lista'}
